...
public class SnowFlake {
    ...
    public synchronized long nextId() {
        ...
        return (currStmp - START_STMP) << TIMESTMP_LEFT //时间戳部分 timestamp part
                | datacenterId << DATACENTER_LEFT       //数据中心部分 Data Center part
                | machineId << MACHINE_LEFT             //机器标识部分 Machine Identification part
                | sequence;                             //序列号部分 serial number part
    }
