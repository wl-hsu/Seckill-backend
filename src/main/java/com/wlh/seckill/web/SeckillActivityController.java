...
//            }
    ...
    public String getSystemTime() {
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//设置日期格式 set date format
        String date = df.format(new Date());// new Date()为获取当前系统时间 To get the current system time
        return date;
    }
